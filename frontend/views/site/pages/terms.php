...
<div class="container">
    <div class="row">
        <div class="col-lg-12 text-center">
            ...
            <p>Last updated: September 12, 2016</p>
            <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the localhost
                website (the "Service") operated by My Site ("us", "we", or "our").</p>
            ...
            <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of
                the terms then you may not access the Service. This <a
                    href="https://termsfeed.com/terms-service/generator/">Terms of Service</a> was created with the help
                of TermsFeed.</p>
            ...
            <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by My
                Site.</p>
            <p>My Site has no control over, and assumes no responsibility for, the content, privacy policies, or
                practices of any third party web sites or services. You further acknowledge and agree that My Site shall
